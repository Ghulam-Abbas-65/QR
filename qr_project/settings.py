...
# CORS settings - works everywhere (localhost, Vercel, AWS, any domain)
...
# Exempt CSRF for API endpoints using token authentication
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@qrgenerator.com')
